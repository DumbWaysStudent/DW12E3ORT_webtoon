...
import { Text, Container, Input, Button, View, Form, Item, Header, Content, Icon } from 'native-base';
    ...
    renderList = () => {
        return (
            <Container>
                ...
                <Button success style={styles.forItem} disabled={this.validate()} onPress={() => this.props.navigation.navigate('App')}>
